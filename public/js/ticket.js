...
function newTicket(){
    ...
    option.value ='IP Request';
    option1.value = 'Login / Registration Issue';
    option3.value = 'Token Demand Issue';
    option4.value = 'Password Reset Request';
    option2.value = 'Video Meet Issue';
    option.innerHTML = 'IP Request';
    option1.innerHTML = 'Login / Registration Issue';
    option3.innerHTML = 'Password Reset Request';
    option4.innerHTML = 'Password Reset Request';
    option2.innerHTML = 'Video Meet Issue';
