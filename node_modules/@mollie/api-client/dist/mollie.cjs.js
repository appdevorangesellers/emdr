...
class NetworkClient {
  constructor(_ref) {
    let {
      ...
      nodeVersion
        ...
        axiosOptions = _objectWithoutProperties(_ref, ["apiKey", "accessToken", "versionStrings", "apiEndpoint", "caCertificates", "libraryVersion", "nodeVersion"]);
  ...
  post(url, data, query = {}) {
    ...
    return _asyncToGenerator(function* () {
      try {
        var response = yield _this.axiosInstance.post(`${url}${stringifyQuery(query)}`, data);
      } catch (error) {
  ...
  get(url, query = {}) {
    ...
    return _asyncToGenerator(function* () {
      try {
        var response = yield _this2.axiosInstance.get(`${url}${stringifyQuery(query)}`);
      } catch (error) {
        if (error.response != undefined) {
          throw ApiError.createFromResponse(error.response);
        }
  ...
  list(url, resourceName, query = {}) {
    var _this3 = this;

    return _asyncToGenerator(function* () {
      try {
        var response = yield _this3.axiosInstance.get(`${url}${stringifyQuery(query)}`);
      } catch (error) {
        if (error.response != undefined) {
          throw ApiError.createFromResponse(error.response);
        }
      ...
      return Object.assign(Array.from(embedded[resourceName]), {
        links,
        count
      });
    })();
  ...
  patch(url, data) {
    ...
    return _asyncToGenerator(function* () {
      try {
        var response = yield _this4.axiosInstance.patch(url, data);
      } catch (error) {
        if (error.response != undefined) {
          throw ApiError.createFromResponse(error.response);
        }
  ...
  delete(url, context) {
    ...
    return _asyncToGenerator(function* () {
      try {
        var response = yield _this5.axiosInstance.delete(url, {
          data: context
        });
      } catch (error) {
        if (error.response != undefined) {
...
class ApplePayResource {
  ...
  requestPaymentSession(parameters) {
    ...
    return this.networkClient.post('wallets/applepay/sessions', parameters);
  }
...
var refundHelpers = _objectSpread2(_objectSpread2({}, commonHelpers), {}, {
  /**
...
function injectPrototypes$d(input) {
  ...
  if (input.lines != undefined) {
    lines = input.lines.map(injectPrototypes$e);
  }
...
var paymentHelpers = _objectSpread2(_objectSpread2({}, commonHelpers), {}, {
  /**
...
function injectPrototypes$c(input) {
  ...
  if (input._embedded != undefined) {
    ...
    if (input._embedded.chargebacks != undefined) {
      _embedded.chargebacks = input._embedded.chargebacks.map(injectPrototypes$b);
    }

    if (input._embedded.refunds != undefined) {
      _embedded.refunds = input._embedded.refunds.map(injectPrototypes$d);
    }
  }
...
function injectPrototypes$b(input) {
  ...
  if (input._embedded != undefined) {
    ...
    if (input._embedded.payments != undefined) {
      _embedded.payments = input._embedded.payments.map(injectPrototypes$c);
    }
  }
...
class TransformingNetworkClient {
  constructor(networkClient, transform) {
    this.networkClient = networkClient;
...
class ChargebacksResource extends ParentedResource {
  constructor(networkClient) {
    super(new TransformingNetworkClient(networkClient, injectPrototypes$b));
...
var mandateHelpers = _objectSpread2(_objectSpread2({}, commonHelpers), {}, {
  /**
...
class CustomersMandatesResource extends ParentedResource {
  constructor(networkClient) {
    super(new TransformingNetworkClient(networkClient, injectPrototypes$a));
  ...
  create(parameters) {
    ...
    return this.networkClient.post(this.getResourceUrl(customerId), data);
  }
  /**
  ...
  list(parameters) {
    ...
    return this.networkClient.list(this.getResourceUrl(customerId), 'mandates', query).then(result => this.injectPaginationHelpers(result, this.list, parameters !== null && parameters !== void 0 ? parameters : {}));
  }
  /**
  ...
  revoke(id, parameters) {
    ...
    return this.networkClient.delete(`${this.getResourceUrl(customerId)}/${id}`, context);
  }
...
class CustomersPaymentsResource extends ParentedResource {
  constructor(networkClient) {
    super(new TransformingNetworkClient(networkClient, injectPrototypes$c));
  ...
  list(parameters) {
    ...
    return this.networkClient.list(this.getResourceUrl(customerId), 'payments', query).then(result => this.injectPaginationHelpers(result, this.list, parameters !== null && parameters !== void 0 ? parameters : {}));
  }
...
class CustomersResource extends Resource {
  constructor(networkClient) {
    super(new TransformingNetworkClient(networkClient, injectPrototypes$9));
  ...
  delete(id, parameters) {
    ...
    return this.networkClient.delete(`${this.getResourceUrl()}/${id}`, parameters);
  }
...
var subscriptionHelpers = _objectSpread2(_objectSpread2({}, commonHelpers), {}, {
  /**
...
class CustomersSubscriptionsResource extends ParentedResource {
  constructor(networkClient) {
    super(new TransformingNetworkClient(networkClient, injectPrototypes$8));
  ...
  list(parameters) {
    ...
    return this.networkClient.list(this.getResourceUrl(customerId), 'subscriptions', query).then(result => this.injectPaginationHelpers(result, this.list, parameters !== null && parameters !== void 0 ? parameters : {}));
  }
  /**
...
var methodHelpers = _objectSpread2(_objectSpread2({}, commonHelpers), {}, {
  /**
...
class MethodsResource extends Resource {
  constructor(networkClient) {
    super(new TransformingNetworkClient(networkClient, injectPrototypes$7));
...
var onboardingHelpers = _objectSpread2(_objectSpread2({}, commonHelpers), {}, {
...
class OnboardingResource extends Resource {
  constructor(networkClient) {
    super(new TransformingNetworkClient(networkClient, injectPrototypes$6));
  }
...
var orderHelpers = _objectSpread2(_objectSpread2({}, commonHelpers), {}, {
  /**
...
function injectPrototypes$4(input) {
  ...
  if (input._embedded != undefined) {
    ...
    if (input._embedded.shipments != undefined) {
      _embedded.shipments = input._embedded.shipments.map(injectPrototypes$5);
    }
  }
...
class OrdersLinesResource extends ParentedResource {
  constructor(networkClient) {
    super(new TransformingNetworkClient(networkClient, injectPrototypes$4));
  ...
  cancel(parameters) {
    ...
    return this.networkClient.delete(this.getResourceUrl(orderId), data);
  }
...
class OrdersPaymentsResource extends ParentedResource {
  ...
  create(parameters) {
    ...
    return this.networkClient.post(this.getResourceUrl(orderId), data);
  }

}

class RefundsResource$1 extends ParentedResource {
  constructor(networkClient) {
    super(new TransformingNetworkClient(networkClient, injectPrototypes$d));
  ...
  list(parameters) {
    ...
    return this.networkClient.list(this.getResourceUrl(orderId), 'refunds', query).then(result => this.injectPaginationHelpers(result, this.list, parameters !== null && parameters !== void 0 ? parameters : {}));
  }
  ...
  create(parameters) {
    ...
    const {
      embed
          ...
          data = _objectWithoutProperties(parameters, ["embed"]);

    const query = embed != undefined ? {
      embed
    } : undefined;
    return this.networkClient.post(this.getResourceUrl(), data, query);
  }
  /**
...
class OrdersShipmentsResource extends ParentedResource {
  constructor(networkClient) {
    super(new TransformingNetworkClient(networkClient, injectPrototypes$5));
...
class OrganizationsResource extends Resource {
  constructor(networkClient) {
    super(new TransformingNetworkClient(networkClient, injectPrototypes$3));
  }
...
class PaymentsCapturesResource extends ParentedResource {
  constructor(networkClient) {
    super(new TransformingNetworkClient(networkClient, injectPrototypes$2));
...
class PaymentsRefundsResource extends ParentedResource {
  ...
  cancel(id, parameters) {
    ...
    return this.networkClient.delete(`${this.getResourceUrl(paymentId)}/${id}`, context);
  }
  ...
  create(parameters) {
    ...
    const {
      include
          ...
          data = _objectWithoutProperties(parameters, ["include"]);
...
class PermissionsResource extends Resource {
  constructor(networkClient) {
    super(new TransformingNetworkClient(networkClient, injectPrototypes$1));
  }
  ...
  list() {
    if (renege(this, this.list, ...arguments)) return;
    return this.networkClient.list(this.getResourceUrl(), 'permissions', {}).then(result => this.injectPaginationHelpers(result, this.list, undefined));
  }

}

var profileHelpers = _objectSpread2(_objectSpread2({}, commonHelpers), {}, {
...
class ProfilesResource extends Resource {
  ...
  delete(id) {
    ...
    return this.networkClient.delete(`${this.getResourceUrl()}/${id}`);
  }
...
class SubscriptionsPaymentsResource extends ParentedResource {
  constructor(networkClient) {
    super(new TransformingNetworkClient(networkClient, injectPrototypes$c));
  }

  getResourceUrl(customerId, subscriptionId) {
  ...
  list(parameters) {
    ...
    const query = _objectWithoutProperties(parameters, ["customerId", "subscriptionId"]);
...
function createMollieClient(options) {
  ...
  return {
    ...
    orders_refunds: new RefundsResource$1(networkClient),
